...
// Get JSON data
treeJSON = d3.json("Data1.json", function(error, treeData) {
...
//if (d.name=="typeOrigin"){
 ...
 var n= Object.keys(my_JSON_object.name);

    console.log (my_JSON_object);

    console.log (my_JSON_object.children[0].children[0].children[1].children[0].value);
